...
async def delete_employee_route(user_base:UserBase,employee_id: str, db: Session = Depends(get_db)):
    db_employee = delete_employee_employment_details(db, employee_id,user_base.username)
